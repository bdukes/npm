...
test('save behavior', function (t) {
  ...
  t.test('to package.json and npm-shrinkwrap.json w/ abs', function (t) {
    common.npm(['install', '--save', 'file:' + testdir + '/pkga'], {cwd: sbdir, env: conf.env}, function (err, code, stdout, stderr) {
      if (err) throw err
      t.is(code, 0, 'command ran ok')
  ...
  t.test('to package.json and npm-shrinkwrap.json w/ rel', function (t) {
    common.npm(['install', '--save', 'file:../pkgb'], {cwd: sbdir, env: conf.env}, function (err, code, stdout, stderr) {
      if (err) throw err
      t.is(code, 0, 'command ran ok')
      var pjson = readJson(sbdir + '/package.json')
      var shrinkwrap = readJson(sbdir + '/npm-shrinkwrap.json')
  ...
  t.test('internal transitive dependencies of shrinkwraps', function (t) {
    common.npm(['install', '--save', 'file:transitive'], {cwd: sbdir, env: conf.env}, function (err, code, stdout, stderr) {
      if (err) throw err
      t.is(code, 0, 'command ran ok')
      var pjson = readJson(sbdir + '/package.json')
      var shrinkwrap = readJson(sbdir + '/npm-shrinkwrap.json')
  ...
  t.test('external transitive dependencies of shrinkwraps', function (t) {
    common.npm(['install', '--save', 'file:../sb-transitive'], {cwd: sbdir, env: conf.env}, function (err, code, stdout, stderr) {
      if (err) throw err
      t.is(code, 0, 'command ran ok')
      var pjson = readJson(sbdir + '/package.json')
      var shrinkwrap = readJson(sbdir + '/npm-shrinkwrap.json')
  ...
  t.test('external transitive dependencies of shrinkwraps > preserve symlinks', function (t) {
    ...
    common.npm(['install', '--save', 'file:../sb-transitive-preserve'], {cwd: sbdir, env: env}, function (err, code, stdout, stderr) {
      if (err) throw err
      t.is(code, 0, 'command ran ok')
      var pjson = readJson(sbdir + '/package.json')
      var shrinkwrap = readJson(sbdir + '/npm-shrinkwrap.json')
